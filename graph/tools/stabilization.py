...
@tool
def run_stabilization_pipeline(sequence_file: str, target_name: str, output_dir: str, email: str, catalytic_residual:str) -> dict:
    """Run the full stabilization pipeline."""
    return run_full_pipeline(target_name, sequence_file, output_dir, email, catalytic_residual)